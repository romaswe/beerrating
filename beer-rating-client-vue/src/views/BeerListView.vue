...
//import { Beer } from '@/models/Beer'; // Assuming you have the Beer interface in models folder
        ...
        <div class="stats">
          <div v-for="(styleStats, index) in beers.styleArray" :key="index" class="styleWrapper">
            ...
            <div v-if="styleStats[1].topBeer" class="top-beer-info">
              <h3>Top beer: {{ styleStats[1].topBeer?.name }} ({{ styleStats[1].topBeer?.rating }})</h3>
